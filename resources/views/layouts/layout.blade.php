                    ...
                    <div id="leagues" style="margin-top:20%">
                        ...
                        @foreach($leagues as $league)
                            <p class="text-md-center font-weight-light sidefont">
                                <a href="/?league={{$league->league}}" style="color: white; text-decoration: none" onmouseover="this.style.color='#D8D8D8'" onmouseout="this.style.color='white'">{{$league->league}}</a>
                            </p>
                        @endforeach
                    </div>
